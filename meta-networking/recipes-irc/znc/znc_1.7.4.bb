...
SRC_URI = "git://github.com/znc/znc.git;protocol=https;name=znc \
           git://github.com/jimloco/Csocket.git;protocol=https;destsuffix=git/third_party/Csocket;name=Csocket \
          "
