...
SRC_URI = "git://github.com/LINBIT/drbd-utils;protocol=https;name=drbd-utils \
           git://github.com/LINBIT/drbd-headers;protocol=https;name=drbd-headers;destsuffix=git/drbd-headers \
